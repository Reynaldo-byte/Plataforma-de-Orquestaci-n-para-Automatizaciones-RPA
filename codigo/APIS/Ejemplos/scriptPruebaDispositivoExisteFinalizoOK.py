...
execution_id = start_execution("My Selenium Automation", dispositivo_nombre="DispositivoExiste", automatizacion_nombre="My Selenium Automation")

try:
    # Tu código de Selenium aquí
    driver.get("http://example.com")
    # Log metrics
    log_metric(execution_id, metrica_nombre="MetricName", valor=123.45)
